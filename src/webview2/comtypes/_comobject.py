...
from . import COMError, ReturnHRESULT, instancemethod, _encode_idl #, IPersist
from .errorinfo import ISupportErrorInfo, ReportException, ReportError
from .hresult import (
...
#
#    def run_sta(self):
#        from winapp.comtypes import messageloop
#        messageloop.run()
#
#    def run_mta(self):
#        import queue
...
#            from winapp.comtypes.typeinfo import LoadRegTypeLib
