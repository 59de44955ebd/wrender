...
from . import IUnknown, GUID, IID, STDMETHOD, BSTR, COMMETHOD, COMError
from .hresult import *
from .patcher import Patch

__all__ = ["Variant", "IDispatch"]
...
#            from winapp.comtypes.typeinfo import GetRecordInfoFromGuids
    ...
    def _get_value(self, dynamic=False):
        ...
        if vt in (VT_EMPTY, VT_NULL):
            ...
            if not dynamic:
                return ptr.__ctypes_from_outparam__()
#            else:
#                from winapp.comtypes.client.dynamic import Dispatch
#                return Dispatch(ptr)
        # see also c:/sf/pywin32/com/win32com/src/oleargs.cpp
        elif self.vt & VT_BYREF:
            return self
#        elif vt == VT_RECORD:
#            from winapp.comtypes.client import GetModule
#            from winapp.comtypes.typeinfo import IRecordInfo
#
...
#        import winapp.comtypes.typeinfo
#        result = self._GetTypeInfo(index, lcid)
#        return result.QueryInterface(winapp.comtypes.typeinfo.ITypeInfo)
